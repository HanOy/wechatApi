...
import club.hoy.weixin.model.SnsToken;
import club.hoy.weixin.model.User;
...
public class SnsAPI extends BaseAPI {
	...
	public static BaseResult validateAccessToken(String access_token, String openid) {
		HttpUriRequest httpUriRequest = RequestBuilder.get()
				.setUri(BASE_URI + "/sns/oauth?access_token=" + access_token + "&openid=" + openid + "").build();
	 ...
	 * @return
	 */
	public static SnsToken oauth2ComponentRefreshToken(String appid, String refresh_token, String component_appid,
			String component_access_token) {
