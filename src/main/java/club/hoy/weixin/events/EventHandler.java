...
public abstract interface EventHandler
{
  ...
  public abstract String handle(EventMessage paramEventMessage, EVENT_TYPE paramEVENT_TYPE)
    throws CodedException;

  public static class ErrorCodes
  {
    private static final String MODULE_CODE = "weixin.event.EventHandler";
    public static final ErrorCode CAN_NOT_FOUND_MATHED_EVENT_HANDLER = Exceptions.errorCode("weixin.event.EventHandler", "CAN_NOT_FOUND_MATHED_EVENT_HANDLER");
  }
}